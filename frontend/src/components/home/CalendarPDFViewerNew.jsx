...
// FIX: Use LOCAL worker v4.4.168 to match package.json and avoid CORS
pdfjs.GlobalWorkerOptions.workerSrc = `/pdf.worker.min.mjs`;

export const CalendarPDFViewerNew = () => {
    // Debug Log to confirm version loaded
    useEffect(() => { console.log("CalendarPDFViewerNew v4.0 Loaded"); }, []);
                ...
                <Document
                    ...
                    error={
                        <div className="flex flex-col items-center gap-4 p-8 text-center">
                            ...
                            <div className="text-xs text-gray-400">Error: V4_FIXED</div>
                            <button
                                onClick={handleRetry}
